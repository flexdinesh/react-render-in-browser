...
class RenderInBrowser extends Component {
  constructor(props) {
    super(props);
    this.currentBrowser = isBrowser ? RenderInBrowser.getCurrentBrowser() : undefined;
  }
  ...
  shouldRenderForBrowser() {
    ...
    for (let prop in this.props) {
      if (this.props.hasOwnProperty(prop) && this.props[prop] === true) browsersInProps.push(prop);
    }
